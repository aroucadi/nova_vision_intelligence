      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="px-4 py-2 rounded-full bg-emerald-500/10 text-emerald-400 text-sm font-medium flex items-center gap-2 border border-emerald-500/20">
              <Activity className="h-4 w-4" /> System Operational
            </div>
        ...
        {/* Journey Selection */}
        <h2 className="text-sm font-semibold text-zinc-500 uppercase tracking-widest mb-6">Select Operation Mode</h2>
...
function ActivityRow({ time, agent, action, status }: { time: string, agent: string, action: string, status: string }) {
  return (
    <div className="flex items-center justify-between text-sm p-3 hover:bg-white/5 rounded-lg transition-colors border-b border-zinc-800/50 last:border-0">
